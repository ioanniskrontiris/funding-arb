...
from funding_arb.notify import send_telegram, fmt_open, fmt_close, fmt_risk
...
# Slightly easier thresholds so testnet actually moves
OPEN_TH  = 0.5           # was 1.0
...
def main():
    ...
    while time.time() < end_time:
        ...
        # 7) status + persist once per second (telegram status muted)
